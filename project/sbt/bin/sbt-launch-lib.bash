...
declare -r sbt_home=$sbt_bin_dir #"$(dirname "$sbt_bin_dir")"
...
jar_file () {
  # echo sbt home is $sbt_home
  # echo sbt bin dir is $sbt_bin_dir
  echo "$(cygwinpath "${sbt_home}/project/sbt/bin/sbt-launch.jar")"
}
